...
def summarize_backups(soup):
    pattern = os.path.join(r"\\houdrsmb\Backup\DR\webgisdr\backups", "*-FULL.webgissite")
...
if __name__ == "__main__":
    webgisdr_log = r"\\houdrsmb\Backup\DR\webgisdr\logs\webgisdr-full.log.json"
    ...
    shutil.copy(webgisdr_log, fr"\\houdrsmb\Backup\DR\webgisdr\logs\webgisdr-full-{date_str}.log.json")
