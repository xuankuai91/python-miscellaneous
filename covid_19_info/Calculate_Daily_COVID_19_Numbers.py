...
def copy_counts(table, fields, county_summary, day):
...
def calculate_change(table, day):
    ...
    arcpy.CalculateField_management('table_vw', "Change", str(change))
    arcpy.CalculateField_management('table_vw', "Mov_Avg", str(moving_average))

def calculate_table(table, fields, county_summary, day):
    copy_counts(table, fields, county_summary, day)
...
def main():
    ...
    confirmed_table = r"Database Connections\Global_SDE_(Global_Admin).sde\Global.GLOBAL_ADMIN.HGAC_COVID_19_Confirmed_Cases_and_Tests"
    ...
    active_table = r"Database Connections\Global_SDE_(Global_Admin).sde\Global.GLOBAL_ADMIN.HGAC_COVID_19_Active_Cases"
    ...
    deceased_table = r"Database Connections\Global_SDE_(Global_Admin).sde\Global.GLOBAL_ADMIN.HGAC_COVID_19_Deceased_Cases"
    ...
    recovered_table = r"Database Connections\Global_SDE_(Global_Admin).sde\Global.GLOBAL_ADMIN.HGAC_COVID_19_Recovered_Cases"
